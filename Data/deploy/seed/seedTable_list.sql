...
('À lire'::text, 'Les livres que je veux lire'::text, '1'::integer, '2'::integer),
('Lus'::text, 'Les livres que j''ai lu'::text, '0'::integer, '3'::integer),
('À lire'::text, 'Les livres que je veux lire'::text, '1'::integer, '3'::integer),
('Lus'::text, 'Les livres que j''ai lu'::text, '0'::integer, '4'::integer),
('À lire'::text, 'Les livres que je veux lire'::text, '1'::integer, '4'::integer),
('Lus'::text, 'Les livres que j''ai lu'::text, '0'::integer, '5'::integer),
('À lire'::text, 'Les livres que je veux lire'::text, '1'::integer, '5'::integer),
('Lus'::text, 'Les livres que j''ai lu'::text, '0'::integer, '6'::integer),
('À lire'::text, 'Les livres que je veux lire'::text, '1'::integer, '6'::integer),
('Lus'::text, 'Les livres que j''ai lu'::text, '0'::integer, '7'::integer),
('À lire'::text, 'Les livres que je veux lire'::text, '1'::integer, '7'::integer),
('Lus'::text, 'Les livres que j''ai lu'::text, '0'::integer, '8'::integer),
('À lire'::text, 'Les livres que je veux lire'::text, '1'::integer, '8'::integer),
('Lus'::text, 'Les livres que j''ai lu'::text, '0'::integer, '9'::integer),
('À lire'::text, 'Les livres que je veux lire'::text, '1'::integer, '9'::integer),
('Lus'::text, 'Les livres que j''ai lu'::text, '0'::integer, '10'::integer),
('À lire'::text, 'Les livres que je veux lire'::text, '1'::integer, '10'::integer)
